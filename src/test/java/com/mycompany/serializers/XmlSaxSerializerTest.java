...
public class XmlSaxSerializerTest {
    private XmlSaxSerializer xmlSaxSerializer;
    ...
    public XmlSaxSerializerTest() {
        xmlSaxSerializer = new XmlSaxSerializer();
    ...
    public void testAuthorsDeserializer() throws Exception {
        List<Author> authors = xmlSaxSerializer.deserializeObject(TEST_FILE_WITH_OBJECTS).getAuthors();
    ...
    public void testBooksDeserializer() throws Exception {
        List<Book> books = xmlSaxSerializer.deserializeObject(TEST_FILE_WITH_OBJECTS).getBooks();
    ...
    public void testPublishersDeserializer() throws Exception {
        List<Publisher> publishers = xmlSaxSerializer.deserializeObject(TEST_FILE_WITH_OBJECTS).getPublishers();
